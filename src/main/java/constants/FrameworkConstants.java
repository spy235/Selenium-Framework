...
public final class FrameworkConstants {
	...
	public static final String ENV = PropertiesHelpers.getValue("ENV");
	...
	/**
	 * Retrieves the file path for the extent report.
	 * 
	 * @return The file path of the extent report as a String.
	 */
